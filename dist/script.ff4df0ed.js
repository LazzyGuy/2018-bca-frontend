...
var DATA_URI = "https://cors-anywhere.herokuapp.com/https://raw.githubusercontent.com/LazzyGuy/js-scraping-example/master/data/high.json";
var data = {};
...
function searchData(event) {
  ...
  if (x == "13") {
    ...
    var newObj = data.filter(function (e) {
      return rx.test(e.NAME.toString().toLowerCase()) || rx.test(e.ROLLNO.toString());
    });
    if (newObj.length == 0) {
      console.log("noting");
    } else {
...
var display = document.querySelector(".display__container");
function createCard(name, rank, total) {
  var IMG_URI = "https://robohash.org/";
  var UImg = function UImg(name) {
    return IMG_URI + name;
  };
...
},{}]},{},["../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/script.js"], null)
//# sourceMappingURL=/script.ff4df0ed.map